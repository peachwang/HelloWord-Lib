...
print(fun1.__code__)
for name in [ 'co_argcount', 'co_varnames', 'co_consts', 'co_nlocals', 'co_cellvars', 'co_code', 'co_filename', 'co_firstlineno', 'co_flags', 'co_freevars', 'co_kwonlyargcount', 'co_lnotab', 'co_name', 'co_names', 'co_stacksize'] :
    print('{}\t\t\t{}'.format(name, fun1.__code__.__getattribute__(name)))
# print(fun1.__code__.co_code.decode())
print(inspect.getargspec(fun1).args)
exit()
